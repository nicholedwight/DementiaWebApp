...
<div class="main" role="main">
  ...
  <div class="wrapper response-page">
  <?php
  ...
  <p class="heading">Success!</p>
    	<p>&nbsp;</p>
  	<p>Thank You <b><?php echo $name; ?></b>! We've received your contact request successfully.</p>
  ...
  ?>
  <p class="heading">Oops! Looks like something went wrong.</p>
    	<p>&nbsp;</p>
